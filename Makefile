...
# BUILD AUTOGENERATED
build: build-english-forward build-english-reverse build-dutch-forward build-dutch-reverse build-blind-forward build-blind-reverse build-blind-bid build-auction-root build-test-auction-root build-test-wallet build-test-deployer
	@echo "Building all"
...
# TESTS AUTOGENERATED
tests: tests-english-forward tests-english-reverse tests-dutch-forward tests-dutch-reverse tests-blind-forward tests-blind-reverse tests-root
	@echo "Testing all"
