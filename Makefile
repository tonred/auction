...
# BUILD AUTOGENERATED
build: build-english-forward build-english-reverse build-dutch-forward build-dutch-reverse build-blind-forward build-blind-reverse build-blind-bid build-auction-root build-test-auction-root build-test-wallet build-test-deployer build-test-usage
	@echo "Building all"
