...
build-tip3-root:
	@echo "Compiling RootTokenContract"
	$(call compile_all,$(CONTRACTS_PATH)/tip3,RootTokenContract)

build-tip3-wallet:
	@echo "Compiling TONTokenWallet.sol"
	$(call compile_all,$(CONTRACTS_PATH)/tip3,TONTokenWallet)

build-test-tip3-root-deployer:
	@echo "Compiling TestTIP3RootDeployer"
